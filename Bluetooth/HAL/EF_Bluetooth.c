...
const char * CommuncationCommandsArray [15] =
...
void void_InitConsole(U32_t BaudRate)
{
...
**********************************************************************/
BOOLEAN EF_BOOLEAN_Bluetooth_GetCharArray( U8_t UART_Number ,U8_t * ReturnedArray, U16_t NewLine_Numbers )
{
    ...
    volatile U8_t ReceviedByte = 0;

    do
    {
//        _delay_us(6);
       EF_BOOLEAN_UART_GetChar( BLUETOOTH_UART_NUMBER, &ReceviedByte );
...
BOOLEAN EF_BOOLEAN_Bluetooth_ReadUntilExpectedKeyword (U8_t* ExpectedKeyword, U8_t ExpectedKeyword_Length, U16_t TimeOut)
{
    ...
    {
        EF_BOOLEAN_UART_GetChar( BLUETOOTH_UART_NUMBER, &RxData[index] );
    }
    _delay_us(25);
    ...
    while (EF_BOOLEAN_TimerCheck( Bluetooth_FIND_KEYWORD_ID ) == FALSE)
    {
        ...
        EF_BOOLEAN_UART_GetChar( BLUETOOTH_UART_NUMBER, &RxData[ExpectedKeyword_Length-1] );
    }
...
BOOLEAN EF_BOOLEAN_Bluetooth_ModuleInit ( BOOLEAN bMaster, U8_t* Password , U8_t* ModuleName , U8_t ModuleName_Length)
{
     ...
     *  */
    UART_cfg_str  uart_cfg = {BLUETOOTH_UART_NUMBER, 38400, NUMBER_OF_BITS_8, ONE_STOP_BIT, NO_PARITY, FALSE, FALSE, TRUE, TRUE};

    EF_void_UART_Init (&uart_cfg);

    /* connect pin 34 in module to 3.3v to Enable all AT Command
     * if Connection is Success , then connect it to zero to Communication mode */
    EF_S8_t_DIO_InitPin ( ENABLE_AT_COMMAND_PORT, ENABLE_AT_COMMAND_PIN, OUTPUT);
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[RESTORE_FACTORY_SETTING],
    ...
    {
        UARTprintf("\n*** Error: in Init Function at RESTORE_FACTORY_SETTING Command ***\n");
        return FALSE;
    }
    ...
    /**************** GET_VERSION Command *************/
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[GET_VERSION],
            strlen(InitCommandsArray[GET_VERSION]));
//    _delay_ms(10);
    ReturnStatus = EF_BOOLEAN_Bluetooth_GetCharArray( BLUETOOTH_UART_NUMBER, ReturnedArray, 2 );
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[SET_MODULE_NAME],
            strlen(InitCommandsArray[SET_MODULE_NAME]));

    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, ModuleName , ModuleName_Length);
    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, (U8_t*) "\r\n",2);

    ReturnStatus = EF_BOOLEAN_Bluetooth_ReadUntilExpectedKeyword ((U8_t*)"OK", strlen("OK"),1000);

    if (ReturnStatus == FALSE)
    {
        UARTprintf("\n*** Error: in Init Function at SET_MODULE_NAME Command ***\n");
        return FALSE;
    }
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[SET_MODULE_PASSWORD],
            strlen(InitCommandsArray[SET_MODULE_PASSWORD]));
    /* followed by Module name then \r\n */

    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, Password , 4);
    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, (U8_t*) "\r\n",2);
    ...
    if (ReturnStatus == FALSE)
    {
        UARTprintf("\n*** Error: in Init Function at SET_MODULE_PASSWORD Command ***\n");
        return FALSE;
    }
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[CLEAR_PREVIOUSLY_PAIRED_DEVICES],
    ...
    if (ReturnStatus == FALSE)
    {
        UARTprintf("\n*** Error: in Init Function at CLEAR_PREVIOUSLY_PAIRED_DEVICES Command ***\n");
        return FALSE;
    }
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[SET_CONNECTION_TO_ANY_DEVICE],
    ...
    if (ReturnStatus == FALSE)
    {
        UARTprintf("\n*** Error: in Init Function at SET_CONNECTION_TO_ANY_DEVICE Command ***\n");
        return FALSE;
    }
    ...
    {
        /**************** SET_MASTER Command *************/
        EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[SET_MASTER],
        ...
        if (ReturnStatus == FALSE)
        {
            UARTprintf("\n*** Error: in Init Function at SET_MASTER Command ***\n");
            return FALSE;
        }
        ...
        EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[RESET_MODULE],
    ...
    {
        /**************** SET_SLAVE Command *************/
        EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[SET_SLAVE],
       ...
       EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[INITALIZE_SPP_PROFILE],
...
//    U8_t TempIterator = 0;
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[INQUIRE_ACCESS_MODE],
            strlen(CommuncationCommandsArray[INQUIRE_ACCESS_MODE]));

    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, ScanDevicesNumberASCII , ScanDevicesNoOfDigits);
    EF_BOOLEAN_UART_PutChar( BLUETOOTH_UART_NUMBER, ',');
    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, TimeOutASCII , TimeOutNoOfDigits);
    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, (U8_t*) "\r\n",2);
    ...
    for (LoopIterator = 0 ; LoopIterator < ScanDevicesNumber; LoopIterator++)
    {
        ...
        EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[SCAN_DEVICES],
...
//        _delay_ms(1000);
        ...
        {
            ReturnStatus = EF_BOOLEAN_Bluetooth_GetCharArray( BLUETOOTH_UART_NUMBER, ReturnedAddresses, 10 );
...
//            {
//                EF_BOOLEAN_UART_GetChar(BLUETOOTH_UART_NUMBER, (ReturnedAddresses + Counter + TempIterator) );
//            }
...
BOOLEAN EF_BOOLEAN_Bluetooth_MasterConnect (U8_t * SlaveMAC_Add, U8_t TimeOut, U8_t* ReturnSlaveName )
{
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[GET_REMOTE_DEVICE_NAME],
            strlen(CommuncationCommandsArray[GET_REMOTE_DEVICE_NAME]));
    /* followed by MAC_add\r\n */

//    _delay_ms(1000);

    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, SlaveMAC_Add , 14 );
    EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, (U8_t*) "\r\n",2);

//    ReturnStatus = EF_BOOLEAN_Bluetooth_GetCharArray( BLUETOOTH_UART_NUMBER, ReturnSlaveName, 7 );

    ReturnStatus = EF_BOOLEAN_Bluetooth_ReadUntilExpectedKeyword ((U8_t*)"+RNAME:", strlen("+RNAME:"), 10000 );

    if (ReturnStatus == TRUE)
    {
        ReturnStatus = EF_BOOLEAN_Bluetooth_GetCharArray( BLUETOOTH_UART_NUMBER, ReturnSlaveName, 3 );
//
        UARTprintf("\nSlave name is : %s\n", ReturnSlaveName);
//
    }
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[PAIRING],
...
//    ReturnStatus = EF_BOOLEAN_Bluetooth_GetCharArray( BLUETOOTH_UART_NUMBER, ReturnedArray, 3 );
//    UARTprintf("\n%s\n", ReturnedArray);
...
//
    ...
    /**************** BINDING Command *************/
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[BINDING],
...
//    UARTprintf("\n%s\n", ReturnedArray);
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[SET_CONNECTION_TO_DEFINIED_ADD],
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)CommuncationCommandsArray[CONNECT_TO_REMOTE_DEVICE],
...
U8_t EF_u8_Bluetooth_GetModuleStatus ( U8_t* Status )
{
    ...
    EF_void_UART_SendArray ( BLUETOOTH_UART_NUMBER, (U8_t*)InitCommandsArray[GET_MODULE_STATUS],
            strlen(InitCommandsArray[GET_MODULE_STATUS]));

//    ReturnStatus = EF_BOOLEAN_Bluetooth_GetCharArray( BLUETOOTH_UART_NUMBER, ReturnedArray, 7 );
    ...
    if (ReturnStatus == TRUE)
    {
        ...
        ReturnStatus = EF_BOOLEAN_Bluetooth_GetCharArray( BLUETOOTH_UART_NUMBER, Status, 3 );
...
//    if (ReturnStatus == CONNECTED_STATUS )
    {
        ...
        EF_void_UART_SendArray( BLUETOOTH_UART_NUMBER, Data , DataLength );
...
//    {
        ...
        while (EF_BOOLEAN_UART_CheckForRxData( BLUETOOTH_UART_NUMBER ) == TRUE )
        {
            EF_BOOLEAN_UART_GetChar( BLUETOOTH_UART_NUMBER , (RxData_ptr + counter) );
            UARTprintf("%c", RxData_ptr[counter]);
